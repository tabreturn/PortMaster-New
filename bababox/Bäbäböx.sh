...
# variables
GAMEDIR="/$directory/ports/bababox"
...
# reassemble split 7z archive on first run
if [ -f ./assets/data.win.7z.001 ]; then
  "$controlfolder/7zzs.$DEVICE_ARCH" x ./assets/data.win.7z.001 -o./assets/ && rm -f ./assets/data.win.7z.*
fi
