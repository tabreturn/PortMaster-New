...
GAMEDIR=/$directory/ports/groblinsurvivors
godot_runtime="godot_4.3"
godot_executable="godot43.$DEVICE_ARCH"
pck_filename="groblin_windows_patched.pck"
gptk_filename="groblinsurvivors.gptk"
...
# patch file
if [ -f "./groblin_windows.pck" ]; then
    $controlfolder/xdelta3 -d -s "./groblin_windows.pck" "./patch.xdelta3" "./groblin_windows_patched.pck"
    [ $? -eq 0 ] && rm "./groblin_windows.pck" || echo "Patching of Blackout.exe has failed"
fi
