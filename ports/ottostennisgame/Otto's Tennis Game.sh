...
GAMEDIR=/$directory/ports/ottostennisgame
...
$GPTOKEYB "$runtime" -c "./ottostennisgame.gptk" &
pm_platform_helper "$runtime"
LD_PRELOAD="$GAMEDIR/lib/libcrusty.so" "$runtime" $GODOT_OPTS --main-pack "ottostennis.pck"
