...
# variables
GAMEDIR=/$directory/ports/sgtpuzzlecollection
...
# delete selected game from previous run
rm -f "$GAMEDIR/launch_me.sh"

# source love2d runtime
source $controlfolder/runtimes/"love_11.5"/love.txt

# run the love menu to select game
$GPTOKEYB2 "$LOVE_GPTK" -c "./menu.love/menu.ini" &
